        ...
        <div  className = {"topNav"} >
            ...
            <ul className={"rightNav"}>
                ...
                <li className = {"dropdowns"}>
                    ...
                    <div className = {"subNavBtn"}>
                        <div className={"faculty"}>
                            <NavLink to = {"/engineering"} exact ={true} className={"styled-buttons"}><i className="fa fa-university" aria-hidden="true"/> Geotechnical Engineering<br/><br/><p className={"professor"}>Professor Sunil Agrawal</p></NavLink><br/>
                            <NavLink to = {"/engineering"} exact ={true} className={"styled-buttons"}><i className="fa fa-university" aria-hidden="true"/> Environmental Engineering<br/><br/><p className={"professor"}>Professor Mohamed Abdou</p></NavLink><br/>
                            <NavLink to = {"/engineering"} exact ={true} className={"styled-buttons"}><i className="fa fa-university" aria-hidden="true"/> Architectural Engineering<br/><br/><p className={"professor"}>Professor J.Keith Nisbett</p></NavLink><br/>
                            <NavLink to = {"/engineering"} exact ={true} className={"styled-buttons"}><i className="fa fa-university" aria-hidden="true"/> Chemical Engineering Degrees<br/><br/><p className={"professor"}>Professor William Dunn</p></NavLink><br/>
                        </div>
                    </div>
                </li>
            </ul>
