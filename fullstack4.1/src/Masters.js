                ...
                <div className= {"faculties middle"}>
                    <div className={"slides"}>
                        ...
                        <div className = {"slide s1"}>
                            <strong><NavLink to = {"/master"} exact ={true} className={"styled-buttons"} id = {"big-titles"}><i className="fa fa-university" aria-hidden="true"/> Social Faculty<br/><br/><p className={"professor"}>Professor Alison Fragale</p></NavLink></strong>
                            <h2 id = {"huge-titles"}><strong>Terms of acceptance</strong></h2>
                           75+ B.A.Average, in Order to Get Accepted in our Faculty
                        </div>
                        <div className = {"slide"}>
                            <strong><NavLink to = {"/master"} exact ={true} className={"styled-buttons"} id = {"big-titles"}><i className="fa fa-university" aria-hidden="true"/> Business Faculty<br/><br/><p className={"professor"}>Professor Eric Sussman</p></NavLink></strong>
                            <h2 id = {"huge-titles"}><strong>Terms of acceptance</strong></h2>
                            80+ B.A. Average, in Order to Get Accepted in our Faculty
                        </div>
                        <div className = {"slide"}>
                            <strong><NavLink to = {"/master"} exact ={true} className={"styled-buttons"} id = {"big-titles"}><i className="fa fa-university" aria-hidden="true"/> Science Faculty<br/><br/><p className={"professor"}>Professor Galileo Galilei</p></NavLink></strong>
                            <h2 id = {"huge-titles"}><strong>Terms of acceptance</strong></h2>
                            87+ B.Sc. Average,  in Order to Get Accepted in our Faculty
                        </div>
                        <div className = {"slide"}>
                            <strong><NavLink to = {"/master"} exact ={true} className={"styled-buttons"} id = {"big-titles"}><i className="fa fa-university" aria-hidden="true"/> Health Faculty<br/><br/><p className={"professor"}>Professor Amedeo Avigadro</p></NavLink></strong>
                            <h2 id = {"huge-titles"}><strong>Terms of acceptance</strong></h2>
