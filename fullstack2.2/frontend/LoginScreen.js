    ...
    render(){
        return <div className = {"login-register-component"} align = {"left"}>
                <div id = {"login"}>
                    ...
                    <br/>
                    <form id = {"password-method"} style = {{display: this.state.passMeth}}>
                    ...
                    <form id = {"phone-method"} style = {{display: this.state.phoneMeth}}>
                ...
                <div id = {"text"}>
                    ...
                    <p>also Make sure you're a Student in our University.</p><br/>
