...
class Masters extends React.Component{
    ...
    async componentDidMount(){
        document.title = "BL Academy - Master Degrees";
        ...
        try{
            const response_healthFaculty = await fetch(`https://blacknightacademynew-backend.herokuapp.com/api/course/getDataByDepartmentName/`+ health_faculty); 
            const response_businessFaculty = await fetch(`https://blacknightacademynew-backend.herokuapp.com/api/course/getDataByDepartmentName/`+ business_faculty); 
            const response_socialFaculty = await fetch(`https://blacknightacademynew-backend.herokuapp.com/api/course/getDataByDepartmentName/`+ social_faculty); 
            const response_scienceFaculty = await fetch(`https://blacknightacademynew-backend.herokuapp.com/api/course/getDataByDepartmentName/`+ science_faculty); 
                        ...
                        <div className = {"slide s1"}>
                            ...
                            <div className={"faculty-class-outer"}>
                                {this.state.Social.map((faculty)=>(
                                    <div className={"faculty-class-inner"} key={faculty.course_name}>
