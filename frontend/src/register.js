...
class register extends React.Component {
    ...
    async componentDidMount(){
        ...
        try{
            ...
            const response_accountDescription = await fetch(`https://blacknightacademynew-backend.herokuapp.com/api/accountDescription/getData/`); 
    ...
    registerStudent = (e) => {
        e.preventDefault();
            ...
            fetch("https://blacknightacademynew-backend.herokuapp.com/api/register/student",requestOptions)
            .then(response => {
                if (response.ok !== true) {
                    this.setState({
                        username:""
    ...
    registerInstructor = (e) => {
        e.preventDefault();
            ...
            fetch("https://blacknightacademynew-backend.herokuapp.com/api/register/instructor",requestOptions)
            .then(response => {
                if (response.ok !== true) {
                    this.setState({
                        username:""
